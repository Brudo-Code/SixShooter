...
{
    public class SixShooterInputHandler : MonoBehaviour
    {
		...
		SixShooterCharacterController m_PlayerCharacterController;
        bool m_FireInputWasHeld;

        void Start()
        {
            m_PlayerCharacterController = GetComponent<SixShooterCharacterController>();
            DebugUtility.HandleErrorIfNullGetComponent<SixShooterCharacterController, PlayerInputHandler>(

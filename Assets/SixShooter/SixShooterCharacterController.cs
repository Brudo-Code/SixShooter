...
{
    [RequireComponent(typeof(SixShooterCharacterController), typeof(SixShooterInputHandler), typeof(AudioSource))]
    public class SixShooterCharacterController : MonoBehaviour
    {
        ...
        SixShooterInputHandler m_InputHandler;
        ...
        void Start()
        {
            ...
            m_InputHandler = GetComponent<SixShooterInputHandler>();
